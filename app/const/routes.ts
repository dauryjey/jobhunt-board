...
export const SIGNUP_EMPLOYER = "/signup/employer";

// Dashboard and Job Management
export const HOME = "/";
export const JOBS_DASHBOARD_PAGE= "/jobs?page=";
...
export const CATEGORY_REACT = "/react?page=1";
export const CATEGORY_VUE = "/vue?page=1";
export const CATEGORY_ANGULAR = "/angular?page=1";